...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ945598(v=OCS.15)
ms:contentKeyID: 52056764
ms.date: 06/25/2014
...
1.  Set the Windows PowerShell execution policy to Unrestricted. To check your execution policy settings, open the Lync Server 管理シェル and run the following command:
    ```PowerShell
        Get-ExecutionPolicy
    ```
