...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398485(v=OCS.15)
ms:contentKeyID: 48272374
ms.date: 05/19/2016
...
Creates a new Kerberos account used for Internet Information Services (IIS) authentication. このコマンドレットは Lync Server 2010 で導入されました。
