...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398620(v=OCS.15)
ms:contentKeyID: 48272646
ms.date: 05/19/2016
...
Sets disclaimer text that will be used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. このコマンドレットは Lync Server 2010 で導入されました。 It has been deprecated for use with Lync Server 2013. For Lync Server 2013, E9-1-1 disclaimers should be configured by using the [New-CsLocationPolicy](new-cslocationpolicy.md) cmdlet and the [Set-CsLocationPolicy](set-cslocationpolicy.md) cmdlet.
