...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425801(v=OCS.15)
ms:contentKeyID: 48271636
ms.date: 05/19/2016
...
Removes the specified client version policy. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. このコマンドレットは Lync Server 2010 で導入されました。
