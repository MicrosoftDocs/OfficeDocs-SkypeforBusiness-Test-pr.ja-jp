...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398304(v=OCS.15)
ms:contentKeyID: 48272022
ms.date: 05/19/2016
...
<td><p>Retrieves the test device data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
