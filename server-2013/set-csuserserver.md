...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413026(v=OCS.15)
ms:contentKeyID: 48273997
ms.date: 05/19/2016
...
Enables you to modify an existing User Services pool. Among other things, the User Services pool provides presence information and helps to manage conferences. このコマンドレットは Lync Server 2010 で導入されました。
