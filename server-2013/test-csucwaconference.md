...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ619178(v=OCS.15)
ms:contentKeyID: 49115218
ms.date: 05/19/2016
...
Tests the ability of a pair of users to schedule, join, and then conduct an online conference using the Unified Communications Web API (UCWA). このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsUcwaConference** cmdlet are not available in the Lync Server コントロール パネル.
