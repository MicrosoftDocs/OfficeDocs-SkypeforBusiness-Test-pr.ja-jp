...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Hh690017(v=OCS.15)
ms:contentKeyID: 48272083
ms.date: 05/19/2016
...
<td><p>Retrieves the mobility policy data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
