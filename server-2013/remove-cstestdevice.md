...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398790(v=OCS.15)
ms:contentKeyID: 48272977
ms.date: 05/19/2016
...
Removes the specified device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. このコマンドレットは Lync Server 2010 で導入されました。
