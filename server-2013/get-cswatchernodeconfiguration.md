...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204739(v=OCS.15)
ms:contentKeyID: 48271553
ms.date: 04/05/2017
...
**Lync Server コントロール パネル:** The functions carried out by the **Get-CsWatcherNodeConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
