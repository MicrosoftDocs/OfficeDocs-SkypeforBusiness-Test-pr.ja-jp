...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398482(v=OCS.15)
ms:contentKeyID: 48272334
ms.date: 05/19/2016
...
Removes an existing collection of Registrar configuration settings. Registrars are used to authenticate logon requests and to maintain information about user status and availability. このコマンドレットは Lync Server 2010 で導入されました。
