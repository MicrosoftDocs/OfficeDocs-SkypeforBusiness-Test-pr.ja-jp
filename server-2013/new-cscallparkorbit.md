...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398936(v=OCS.15)
ms:contentKeyID: 48273779
ms.date: 05/19/2016
...
Creates a new, named range of numbers assigned for parking calls within an organization. このコマンドレットは Lync Server 2010 で導入されました。
