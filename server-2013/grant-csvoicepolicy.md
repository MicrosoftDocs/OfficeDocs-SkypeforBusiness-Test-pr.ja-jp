...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398828(v=OCS.15)
ms:contentKeyID: 48273574
ms.date: 05/19/2016
...
Assigns a voice policy to one or more users or groups. このコマンドレットは Lync Server 2010 で導入されました。
