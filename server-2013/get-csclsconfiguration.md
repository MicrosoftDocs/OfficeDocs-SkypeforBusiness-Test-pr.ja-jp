...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ619179(v=OCS.15)
ms:contentKeyID: 49115220
ms.date: 05/19/2016
...
Returns information about the centralized logging configuration settings in use in the organization. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Get-CsClsConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
