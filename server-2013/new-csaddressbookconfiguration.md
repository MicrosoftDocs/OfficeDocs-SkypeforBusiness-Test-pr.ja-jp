...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398395(v=OCS.15)
ms:contentKeyID: 48272174
ms.date: 05/19/2016
...
Creates a new collection of Address Book configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
