...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398340(v=OCS.15)
ms:contentKeyID: 48272082
ms.date: 05/19/2016
...
Modifies an existing collection of User Services configuration settings. The User Services service is used to help maintain presence information and manage conferencing. このコマンドレットは Lync Server 2010 で導入されました。
