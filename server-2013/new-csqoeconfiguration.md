...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398325(v=OCS.15)
ms:contentKeyID: 48272061
ms.date: 05/19/2016
...
Creates a new collection of QoE (Quality of Experience) settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<p>Note that even if EnableQoE is set to True, QoE data will not be collected unless a 監視サーバー has been deployed and associated with a Registrar pool.</p>
<p>Default: True</p></td>
</tr>
<tr class="even">
