...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425739(v=OCS.15)
ms:contentKeyID: 48271591
ms.date: 05/19/2016
...
Grants Lync Server management rights on an Active Directory organizational unit (OU). このコマンドレットは Lync Server 2010 で導入されました。
