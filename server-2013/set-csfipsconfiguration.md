...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205084(v=OCS.15)
ms:contentKeyID: 48272874
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Set-CsFIPSConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
