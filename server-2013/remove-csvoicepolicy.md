...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398309(v=OCS.15)
ms:contentKeyID: 48272033
ms.date: 05/19/2016
...
Removes the specified voice policy. このコマンドレットは Lync Server 2010 で導入されました。
