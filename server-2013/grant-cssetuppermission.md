...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398569(v=OCS.15)
ms:contentKeyID: 48272491
ms.date: 05/19/2016
...
Grants Lync Server setup permissions on an Active Directory organizational unit (OU). このコマンドレットは Lync Server 2010 で導入されました。
