...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204839(v=OCS.15)
ms:contentKeyID: 48271900
ms.date: 05/19/2016
...
Tests the configuration of the Lync Server 2013 databases. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsDatabase** cmdlet are not available in the Lync Server コントロール パネル.
