...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205373(v=OCS.15)
ms:contentKeyID: 48273979
ms.date: 05/19/2016
...
Imports user data previously exported by using the Export-CsUserData cmdlet. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Import-CsUserData** cmdlet are not available in the Lync Server コントロール パネル.
