...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412987(v=OCS.15)
ms:contentKeyID: 48273953
ms.date: 05/19/2016
...
Modifies an existing location policy. このコマンドレットは Lync Server 2010 で導入されました。
