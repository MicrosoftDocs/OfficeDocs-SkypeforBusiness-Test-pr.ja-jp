...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398489(v=OCS.15)
ms:contentKeyID: 48272345
ms.date: 05/19/2016
...
Specifies the transmission protocol to be used in a static route. Lync Server enables you to choose either Transmission Control Protocol (TCP) or Transport Layer Security (TLS) as the transmission protocol for a route. このコマンドレットは Lync Server 2010 で導入されました。
