...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204658(v=OCS.15)
ms:contentKeyID: 48271189
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **New-CsClsRegion** cmdlet are not available in the Lync Server コントロール パネル.
