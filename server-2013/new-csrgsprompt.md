...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398486(v=OCS.15)
ms:contentKeyID: 48272342
ms.date: 05/19/2016
...
Creates a new workflow prompt for the 応答グループ アプリケーション. A workflow prompt is either an audio file that is played or text that is read aloud in order to supply callers with additional information. このコマンドレットは Lync Server 2010 で導入されました。
