...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425851(v=OCS.15)
ms:contentKeyID: 48271762
ms.date: 05/19/2016
...
Retrieves the routing configuration object, which contains a list of all voice routes defined within a Lync Server deployment. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the routing configuration from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
