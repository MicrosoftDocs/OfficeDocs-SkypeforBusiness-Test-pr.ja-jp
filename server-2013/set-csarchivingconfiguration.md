...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413030(v=OCS.15)
ms:contentKeyID: 48274021
ms.date: 05/19/2016
...
Modifies an existing collection of instant messaging (IM) archiving settings. このコマンドレットは Lync Server 2010 で導入されました。
