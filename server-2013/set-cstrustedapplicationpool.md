...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398187(v=OCS.15)
ms:contentKeyID: 48271283
ms.date: 05/19/2016
...
Modifies a pool that contains the computers that host trusted applications. このコマンドレットは Lync Server 2010 で導入されました。
