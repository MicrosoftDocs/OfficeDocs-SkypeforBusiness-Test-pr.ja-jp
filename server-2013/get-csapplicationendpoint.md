...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398655(v=OCS.15)
ms:contentKeyID: 48272725
ms.date: 05/19/2016
...
Retrieves endpoints for the アプリケーション サービス. このコマンドレットは Lync Server 2010 で導入されました。
...
This cmdlet retrieves one or more application contacts from Active Directory ドメイン サービス. These objects are stored in Active Directory in the Application Contacts container of the RTC service.
