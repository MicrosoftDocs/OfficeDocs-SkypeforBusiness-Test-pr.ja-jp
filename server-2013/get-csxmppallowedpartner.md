...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204981(v=OCS.15)
ms:contentKeyID: 48272399
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** To view information about your XMPP allowed partners in the Lync Server コントロール パネル, click External User Access and then click XMPP Federated Partners.
