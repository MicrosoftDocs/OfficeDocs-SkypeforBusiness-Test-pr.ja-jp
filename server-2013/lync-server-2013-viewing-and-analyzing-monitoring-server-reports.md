...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Dn720332(v=OCS.15)
ms:contentKeyID: 62221614
ms.date: 05/19/2016
...
2.  Open a browser window, and then enter the Admin URL to open the Lync Server コントロール パネル.
...
[Lync Server 2013 のサーバー パフォーマンス レポート](lync-server-2013-server-performance-report.md)  
[メディア品質比較レポート](lync-server-2013-media-quality-comparison-report.md)
