...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398553(v=OCS.15)
ms:contentKeyID: 48272460
ms.date: 05/19/2016
...
Removes an existing collection of proxy server configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
