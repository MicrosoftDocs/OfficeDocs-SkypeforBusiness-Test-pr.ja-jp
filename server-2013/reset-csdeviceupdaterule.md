...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398181(v=OCS.15)
ms:contentKeyID: 48271257
ms.date: 05/19/2016
...
Rejects a device update rule that has been imported to the system. このコマンドレットは Lync Server 2010 で導入されました。
