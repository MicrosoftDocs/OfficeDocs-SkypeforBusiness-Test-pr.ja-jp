...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204801(v=OCS.15)
ms:contentKeyID: 48271754
ms.date: 05/19/2016
...
Modifies and existing Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** To modify an existing Persistent Chat chat room using the Lync Server コントロール パネル, click **Persistent Chat**, click **Room**, then double-click the chat room to be modified.
