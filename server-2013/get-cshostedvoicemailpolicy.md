...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398348(v=OCS.15)
ms:contentKeyID: 48272105
ms.date: 05/19/2016
...
Retrieves a hosted voice mail policy. このコマンドレットは Lync Server 2010 で導入されました。
...
This cmdlet retrieves a policy that specifies how to route unanswered calls to a user to a hosted Exchange ユニファイド メッセージング (UM) service.
...
<td><p>Retrieves the hosted voice mail policy from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
<tr class="even">
