...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ950236(v=OCS.15)
ms:contentKeyID: 52056540
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **New-CsWebOrigin** cmdlet are not available in the Lync Server コントロール パネル.
