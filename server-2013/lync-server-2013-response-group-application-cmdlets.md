---
title: 応答グループ アプリケーションのコマンドレット
TOCTitle: 応答グループ アプリケーションのコマンドレット
ms:assetid: 5710163c-e6c2-4ca5-b247-5bf9df6c954e
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg415654(v=OCS.15)
ms:contentKeyID: 48272151
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# 応答グループ アプリケーションのコマンドレット

 

_**トピックの最終更新日:** 2016-12-08_

応答グループ アプリケーション はエンタープライズ VoIP の通話管理機能で、着信をエージェントのグループにルーティングします。
