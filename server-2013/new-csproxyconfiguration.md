...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398335(v=OCS.15)
ms:contentKeyID: 48272074
ms.date: 05/19/2016
...
Creates a new collection of proxy configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the エッジ サーバー running the アクセス エッジ サービス. The default value is False.</p></td>
</tr>
<tr class="odd">
