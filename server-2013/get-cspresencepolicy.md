...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398463(v=OCS.15)
ms:contentKeyID: 48272303
ms.date: 05/19/2016
...
Returns information about the presence policies configured for use in your organization. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the presence policy data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
