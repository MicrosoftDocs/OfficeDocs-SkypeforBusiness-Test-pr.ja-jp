...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205163(v=OCS.15)
ms:contentKeyID: 48273140
ms.date: 05/19/2016
...
Lync Server コントロール パネル: The functions carried out by the **New-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
