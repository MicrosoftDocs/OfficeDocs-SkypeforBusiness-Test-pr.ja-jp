...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412792(v=OCS.15)
ms:contentKeyID: 48273186
ms.date: 05/19/2016
...
Retrieves one or more ranges of unassigned numbers and the routing rules that apply to those numbers. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the unassigned number information from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
