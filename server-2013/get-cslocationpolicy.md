...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398911(v=OCS.15)
ms:contentKeyID: 48273665
ms.date: 05/19/2016
...
Returns information about how (or if) the Enhanced 9-1-1 (E9-1-1) 場所情報サービス has been configured. The E9-1-1 service enables those who answer emergency calls to determine the caller’s geographic location. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the location policy information from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
