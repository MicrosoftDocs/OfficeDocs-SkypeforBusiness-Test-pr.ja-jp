...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398139(v=OCS.15)
ms:contentKeyID: 48271170
ms.date: 05/19/2016
...
Creates a new Auto Attendant or Subscriber Access contact object for hosted Exchange ユニファイド メッセージング (UM). このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Required</p></td>
<td><p>System.String</p></td>
<td><p>The SIP address of the contact. This must be a new address that does not already exist as a user or contact in Active Directory ドメイン サービス. This value must begin with the string sip: followed by the SIP address.</p></td>
</tr>
<tr class="odd">
