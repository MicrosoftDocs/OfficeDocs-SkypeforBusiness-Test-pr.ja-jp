...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204889(v=OCS.15)
ms:contentKeyID: 48272048
ms.date: 05/19/2016
...
Moves a Lync Server 2013 meeting room object from one Registrar pool to another. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. このコマンドレットは Lync Server 2013 で導入されました。
...
Lync Server コントロール パネル: The functions carried out by the **Move-CsMeetingRoom** cmdlet are not available in the Lync Server コントロール パネル.
