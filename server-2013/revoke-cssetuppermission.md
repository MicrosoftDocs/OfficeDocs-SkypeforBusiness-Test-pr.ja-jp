...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425834(v=OCS.15)
ms:contentKeyID: 48271707
ms.date: 05/19/2016
...
Revokes the Lync Server setup rights that have been granted on an Active Directory organizational unit (OU). このコマンドレットは Lync Server 2010 で導入されました。
