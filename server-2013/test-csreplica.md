...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205289(v=OCS.15)
ms:contentKeyID: 48273618
ms.date: 05/19/2016
...
Verifies the status of the replica service on the local computer. The replica service is used to replicate information among all the Lync Server 2013 computers in your topology. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsReplica** cmdlet are not available in the Lync Server コントロール パネル.
