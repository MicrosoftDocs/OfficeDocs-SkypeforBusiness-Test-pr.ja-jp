...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205326(v=OCS.15)
ms:contentKeyID: 48273777
ms.date: 05/19/2016
...
Returns information about Active Directory principals. These principals include Active Directory objects such as users, groups, contacts, containers, and organizational units. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the Get-CsAdPrincipal cmdlet are not available in the Lync Server コントロール パネル.
