...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398366(v=OCS.15)
ms:contentKeyID: 48272121
ms.date: 05/19/2016
...
Removes an existing server application. Server applications are applications that are hosted by Lync Server. このコマンドレットは Lync Server 2010 で導入されました。
