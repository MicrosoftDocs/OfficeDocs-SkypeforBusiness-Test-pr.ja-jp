...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398226(v=OCS.15)
ms:contentKeyID: 48271367
ms.date: 05/19/2016
...
Creates a new network subnet. このコマンドレットは Lync Server 2010 で導入されました。
