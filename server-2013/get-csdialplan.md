...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413043(v=OCS.15)
ms:contentKeyID: 48274093
ms.date: 05/19/2016
...
Returns information about the dial plans used in your organization. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the dial plan information from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
