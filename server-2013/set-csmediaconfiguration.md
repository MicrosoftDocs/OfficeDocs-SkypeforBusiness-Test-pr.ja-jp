...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398580(v=OCS.15)
ms:contentKeyID: 48272554
ms.date: 05/19/2016
...
Modifies an existing collection of media settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>By default, the 仲介サーバー does not negotiate Siren as a possible codec for calls between itself and other Lync clients. If this setting is True, Siren will be included as a possible codec for use between the 仲介サーバー and other Lync clients.</p></td>
</tr>
<tr class="even">
