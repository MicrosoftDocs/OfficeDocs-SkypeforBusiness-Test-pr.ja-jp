...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425933(v=OCS.15)
ms:contentKeyID: 48271917
ms.date: 05/19/2016
...
Removes the specified device update configuration settings. These settings help manage the デバイス更新 Web サービス, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Phone Edition. このコマンドレットは Lync Server 2010 で導入されました。
