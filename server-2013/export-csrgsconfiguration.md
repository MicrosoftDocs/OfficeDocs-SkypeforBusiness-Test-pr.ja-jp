...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205011(v=OCS.15)
ms:contentKeyID: 48272492
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Export-CsRgsConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
