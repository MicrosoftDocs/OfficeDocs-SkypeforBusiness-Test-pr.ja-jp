...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398865(v=OCS.15)
ms:contentKeyID: 48273635
ms.date: 05/19/2016
...
Removes a SIP domain previously configured for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. このコマンドレットは Lync Server 2010 で導入されました。
