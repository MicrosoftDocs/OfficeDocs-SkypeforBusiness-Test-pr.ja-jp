...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ619191(v=OCS.15)
ms:contentKeyID: 49115249
ms.date: 05/19/2016
...
Removes one or more collections of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Remove-CsClsConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
