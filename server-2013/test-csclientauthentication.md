...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ619181(v=OCS.15)
ms:contentKeyID: 49115223
ms.date: 05/19/2016
...
Determines whether or not a user can log on to Lync Server by using a certificate downloaded from the certificate provisioning service. このコマンドレットは Lync Server 2013 で導入されました。 It replaces the **Test-CSClientAuth** cmdlet used in Lync Server 2010.
