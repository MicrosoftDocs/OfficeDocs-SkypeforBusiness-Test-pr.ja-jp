...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg399032(v=OCS.15)
ms:contentKeyID: 48273901
ms.date: 05/19/2016
...
Creates new instant messaging (IM) session archiving policies. These policies give you the ability to archive all IM sessions that take place between internal users, and/or to archive all IM sessions that take place between internal users and external partners. このコマンドレットは Lync Server 2010 で導入されました。
