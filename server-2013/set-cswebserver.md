...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398759(v=OCS.15)
ms:contentKeyID: 48272931
ms.date: 05/19/2016
...
Modifies one or more of the Web Server services used by Lync Server. このコマンドレットは Lync Server 2010 で導入されました。
