...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398946(v=OCS.15)
ms:contentKeyID: 48273798
ms.date: 05/19/2016
...
Removes an Auto Attendant or Subscriber Access contact object for hosted Exchange ユニファイド メッセージング (UM). このコマンドレットは Lync Server 2010 で導入されました。
