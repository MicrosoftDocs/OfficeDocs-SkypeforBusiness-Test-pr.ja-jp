...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398750(v=OCS.15)
ms:contentKeyID: 48272888
ms.date: 05/19/2016
...
Removes a pool that contains the computers that host trusted applications. このコマンドレットは Lync Server 2010 で導入されました。
