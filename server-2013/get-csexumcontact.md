...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412725(v=OCS.15)
ms:contentKeyID: 48273024
ms.date: 05/19/2016
...
Retrieves one or more hosted Exchange ユニファイド メッセージング (UM) contact objects. このコマンドレットは Lync Server 2010 で導入されました。
