...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398281(v=OCS.15)
ms:contentKeyID: 48271469
ms.date: 05/19/2016
...
Verifies the ability to connect to a federated domain. このコマンドレットは Lync Server 2010 で導入されました。
