...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204721(v=OCS.15)
ms:contentKeyID: 48271427
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** To modify an existing Persistent Chat add-in using the Lync Server コントロール パネル, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
