...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425811(v=OCS.15)
ms:contentKeyID: 48271672
ms.date: 05/19/2016
...
Creates a new collection of static routing configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
