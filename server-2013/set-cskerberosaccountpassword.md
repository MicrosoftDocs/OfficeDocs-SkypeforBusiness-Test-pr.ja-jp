...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398659(v=OCS.15)
ms:contentKeyID: 48272747
ms.date: 05/19/2016
...
Locates each server running Web サービス in a site that has been assigned a Kerberos account, and then updates the Internet Information Services (IIS) configuration settings on each of those servers. このコマンドレットは Lync Server 2010 で導入されました。
