---
title: Lync Server 2013 のコマンドレットのインデックス
TOCTitle: Lync Server 2013 のコマンドレットのインデックス
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398867(v=OCS.15)
ms:contentKeyID: 48273599
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Lync Server 2013 のコマンドレットのインデックス

 

_**トピックの最終更新日:** 2016-12-08_

Microsoft Lync Server 2013 には、管理者がコマンド ラインから Lync Server 2013 を管理するための 700 個を超えるコマンドレットがあります。Lync Server のコマンドレットは、通常は Lync Server 管理シェル で使用します。Lync Server 管理シェルを使用するには、Lync Server のサービスまたはサーバーの役割を実行するコンピューターにログオンし、\[**スタート**\]、\[**すべてのプログラム**\]、\[**Microsoft Lync Server 2013**\]、\[**Lync Server 管理シェル**\] の順にクリックします。管理シェルを開いた後、以下のようにコマンドを入力すると、コマンドレットに関するヘルプをコマンド ラインから直接取得できます。
...
Lync Server の管理に使用できるすべてのコマンドレットの一覧を取得するには、Lync Server 管理シェル コマンド プロンプトで以下の内容を入力します。

    Get-Command * -Module Lync -CommandType cmdlet

Lync Server 管理シェルの詳細については、Lync Server Windows PowerShell ブログ ([http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x411](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x411)) を参照してください。

## Lync Server 2013 のコマンドレット

以下は、Lync Server 2013 に含まれるコマンドレットの一覧です。
