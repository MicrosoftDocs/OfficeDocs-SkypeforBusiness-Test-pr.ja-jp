...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg399004(v=OCS.15)
ms:contentKeyID: 48273851
ms.date: 05/19/2016
...
Retrieves one or more collections of Quality of Experience (QoE) settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the settings from the local replica of the 中央管理ストア.</p></td>
</tr>
</tbody>
</table>
