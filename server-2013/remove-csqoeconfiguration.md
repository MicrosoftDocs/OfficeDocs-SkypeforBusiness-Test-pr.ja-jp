...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425879(v=OCS.15)
ms:contentKeyID: 48271814
ms.date: 05/19/2016
...
Removes a collection of QoE (Quality of Experience) settings. このコマンドレットは Lync Server 2010 で導入されました。
