...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204829(v=OCS.15)
ms:contentKeyID: 48271868
ms.date: 05/19/2016
...
Verifies whether or not a user can employ the Lync Server 2013 Web scheduler to schedule an online meeting. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsWebScheduler** cmdlet are not available in the Lync Server コントロール パネル.
