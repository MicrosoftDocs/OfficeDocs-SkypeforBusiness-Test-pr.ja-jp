...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412932(v=OCS.15)
ms:contentKeyID: 48273427
ms.date: 05/19/2016
...
Removes a SIP response code translation rule. These rules enable administrators to map SIP response codes with values between 400 and 699 to the values used by Lync Server. このコマンドレットは Lync Server 2010 で導入されました。
