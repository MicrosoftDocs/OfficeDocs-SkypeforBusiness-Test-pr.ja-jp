...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398490(v=OCS.15)
ms:contentKeyID: 48272376
ms.date: 05/19/2016
...
Note, too that you cannot federate with a hosting provider if your エッジ サーバー are configured to use default routing rather than Domain Name System (DNS) server routing.
