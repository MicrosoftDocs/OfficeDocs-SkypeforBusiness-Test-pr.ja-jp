...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425845(v=OCS.15)
ms:contentKeyID: 48271752
ms.date: 05/19/2016
...
Modifies an existing Response Group workflow. Workflows determine the actions that are taken when the 応答グループ アプリケーション receives a phone call. このコマンドレットは Lync Server 2010 で導入されました。
