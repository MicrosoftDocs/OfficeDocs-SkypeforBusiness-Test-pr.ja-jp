...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398259(v=OCS.15)
ms:contentKeyID: 48271437
ms.date: 05/19/2016
...
Adds a trusted application to a pool. このコマンドレットは Lync Server 2010 で導入されました。
