...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204903(v=OCS.15)
ms:contentKeyID: 48272145
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Remove-CsBackupServiceConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
