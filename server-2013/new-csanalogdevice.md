...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412937(v=OCS.15)
ms:contentKeyID: 48273451
ms.date: 05/19/2016
...
Creates a new analog device that can be managed by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). このコマンドレットは Lync Server 2010 で導入されました。
