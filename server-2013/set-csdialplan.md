...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398644(v=OCS.15)
ms:contentKeyID: 48272675
ms.date: 05/19/2016
...
Modifies an existing dial plan. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>個々のパラメーター値を設定せずに、コマンドレットにオブジェクトへの参照を渡せます。 You can retrieve this object reference by calling the <strong>Get-CsDialPlan</strong> cmdlet.</p></td>
</tr>
<tr class="even">
