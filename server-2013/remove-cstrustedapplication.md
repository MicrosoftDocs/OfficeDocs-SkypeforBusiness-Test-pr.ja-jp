...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398176(v=OCS.15)
ms:contentKeyID: 48271248
ms.date: 05/19/2016
...
Removes a trusted application from the associated trusted service. このコマンドレットは Lync Server 2010 で導入されました。
