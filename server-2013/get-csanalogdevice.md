...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398748(v=OCS.15)
ms:contentKeyID: 48272883
ms.date: 05/19/2016
...
Returns information about the analog devices you can manage by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network. このコマンドレットは Lync Server 2010 で導入されました。
