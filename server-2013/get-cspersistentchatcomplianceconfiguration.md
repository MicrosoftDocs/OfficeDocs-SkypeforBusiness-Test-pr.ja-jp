...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204625(v=OCS.15)
ms:contentKeyID: 48271068
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Get-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
