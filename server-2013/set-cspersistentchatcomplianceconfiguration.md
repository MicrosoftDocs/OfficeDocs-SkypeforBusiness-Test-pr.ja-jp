...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204949(v=OCS.15)
ms:contentKeyID: 48272299
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Set-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
