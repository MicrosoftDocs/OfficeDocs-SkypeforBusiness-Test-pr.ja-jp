...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413053(v=OCS.15)
ms:contentKeyID: 48274178
ms.date: 05/19/2016
...
Removes a Location Information Server (LIS) subnet. このコマンドレットは Lync Server 2010 で導入されました。
