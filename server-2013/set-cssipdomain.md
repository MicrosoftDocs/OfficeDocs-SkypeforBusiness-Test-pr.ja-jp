...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412949(v=OCS.15)
ms:contentKeyID: 48273487
ms.date: 05/19/2016
...
Enables you to modify property values for the SIP domains in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. このコマンドレットは Lync Server 2010 で導入されました。
