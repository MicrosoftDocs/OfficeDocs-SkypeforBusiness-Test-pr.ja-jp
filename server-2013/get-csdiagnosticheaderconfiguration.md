...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412774(v=OCS.15)
ms:contentKeyID: 48273177
ms.date: 05/19/2016
...
<td><p>Retrieves the diagnostic header configuration data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
