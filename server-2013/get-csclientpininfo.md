...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425947(v=OCS.15)
ms:contentKeyID: 48271944
ms.date: 05/19/2016
...
Retrieves information about the personal identification number (PIN) assigned to a user. このコマンドレットは Lync Server 2010 で導入されました。
