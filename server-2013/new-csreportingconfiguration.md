...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204787(v=OCS.15)
ms:contentKeyID: 48271620
ms.date: 05/19/2016
...
Creates a new collection of reporting configuration settings at the service scope. Reporting configuration settings are used to specify the URL used to access Lync Server 2013 Monitoring Reports. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **New-CsReportingConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
