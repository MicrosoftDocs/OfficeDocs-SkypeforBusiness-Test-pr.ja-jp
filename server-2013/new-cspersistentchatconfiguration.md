...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205330(v=OCS.15)
ms:contentKeyID: 48273876
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** To create a new collection of Persistent Chat configuration settings using the Lync Server コントロール パネル, click **Persistent Chat**, click **Persistent Chat Configuration**, click **New**, and then click either **Site configuration** or **Pool configuration**.
