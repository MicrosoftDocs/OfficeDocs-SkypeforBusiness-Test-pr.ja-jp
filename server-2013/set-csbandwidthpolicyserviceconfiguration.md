...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412863(v=OCS.15)
ms:contentKeyID: 48273316
ms.date: 05/19/2016
...
Modifies an existing bandwidth policy service configuration. このコマンドレットは Lync Server 2010 で導入されました。
