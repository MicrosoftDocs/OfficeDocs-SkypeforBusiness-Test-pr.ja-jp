...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412764(v=OCS.15)
ms:contentKeyID: 48273052
ms.date: 05/19/2016
...
Modifies the security settings on the universal groups created during forest preparation. These modifications provide the permissions needed to host and manage users enabled for Lync Server within the domain. このコマンドレットは Lync Server 2010 で導入されました。
