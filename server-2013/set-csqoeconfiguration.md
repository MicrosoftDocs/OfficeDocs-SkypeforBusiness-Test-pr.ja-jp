...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398245(v=OCS.15)
ms:contentKeyID: 48271414
ms.date: 05/19/2016
...
Modifies an existing collection of QoE (Quality of Experience) settings. このコマンドレットは Lync Server 2010 で導入されました。
...
QoE is part of the 監視サーバー role; therefore 監視サーバー must be deployed on your Lync Server installation before QoE recording takes effect or any QoE data can be collected.
...
<p>Note that even if EnableQoE is set to True, QoE data will not be collected unless a 監視サーバー has been deployed and associated with a Registrar pool.</p></td>
</tr>
<tr class="odd">
