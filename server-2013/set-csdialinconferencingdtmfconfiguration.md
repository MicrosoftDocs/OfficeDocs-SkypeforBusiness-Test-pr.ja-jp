...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398860(v=OCS.15)
ms:contentKeyID: 48273630
ms.date: 05/19/2016
...
Modifies the dual-tone multifrequency (DTMF) signaling settings used for dial-in conferencing. DTMF enables users who dial in to a conference to control conference settings (such as muting and unmuting themselves or locking and unlocking the conference) by using the keypad on their telephone. このコマンドレットは Lync Server 2010 で導入されました。
