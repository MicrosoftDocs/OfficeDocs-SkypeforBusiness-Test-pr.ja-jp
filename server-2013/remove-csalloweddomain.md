...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398913(v=OCS.15)
ms:contentKeyID: 48273667
ms.date: 05/19/2016
...
Removes a domain from the list of domains approved for federation. このコマンドレットは Lync Server 2010 で導入されました。
