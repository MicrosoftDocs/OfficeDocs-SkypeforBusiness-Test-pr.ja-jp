...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398365(v=OCS.15)
ms:contentKeyID: 48272124
ms.date: 05/19/2016
...
Creates a new network site for use with call admission control (CAC) or Enhanced 9-1-1 (E9-1-1). このコマンドレットは Lync Server 2010 で導入されました。
