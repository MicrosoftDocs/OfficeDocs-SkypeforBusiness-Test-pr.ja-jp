...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204896(v=OCS.15)
ms:contentKeyID: 48272100
ms.date: 05/19/2016
...
Modifies an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Set-CsOAuthServer** cmdlet are not available in the Lync Server コントロール パネル.
