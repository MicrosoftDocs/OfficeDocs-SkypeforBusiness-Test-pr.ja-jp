...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412926(v=OCS.15)
ms:contentKeyID: 48273423
ms.date: 05/19/2016
...
Creates a new collection of ユーザー サービス configuration settings. The User Services service is used to help maintain presence information and manage conferencing. このコマンドレットは Lync Server 2010 で導入されました。
