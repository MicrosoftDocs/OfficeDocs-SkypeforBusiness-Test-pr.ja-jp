...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204940(v=OCS.15)
ms:contentKeyID: 48272287
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the Get-CsVoiceRoutingPolicy cmdlet are not available in the Lync Server コントロール パネル.
