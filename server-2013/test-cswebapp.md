...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Hh689989(v=OCS.15)
ms:contentKeyID: 48271085
ms.date: 05/19/2016
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. このコマンドレットは Lync Server 2010 で導入されました。
