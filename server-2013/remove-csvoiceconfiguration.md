...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398804(v=OCS.15)
ms:contentKeyID: 48272959
ms.date: 05/19/2016
...
Resets the voice configuration to its default values. このコマンドレットは Lync Server 2010 で導入されました。
