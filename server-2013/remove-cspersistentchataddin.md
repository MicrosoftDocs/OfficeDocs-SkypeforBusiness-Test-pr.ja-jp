...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205350(v=OCS.15)
ms:contentKeyID: 48273939
ms.date: 05/19/2016
...
Removes an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** To remove a Persistent Chat add-in using the Lync Server コントロール パネル, click **Persistent Chat** and then click **Add-in**. Select the add-in to be removed, click **Edit**, and then click **Delete**.
