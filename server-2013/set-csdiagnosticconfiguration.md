...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425734(v=OCS.15)
ms:contentKeyID: 48271586
ms.date: 05/19/2016
...
Modifies existing diagnostic configuration settings. Diagnostic configuration settings are used to determine whether traffic to or from a given domain or Uniform Resource Identifier (URI) is recorded in your Lync Server log files. このコマンドレットは Lync Server 2010 で導入されました。
