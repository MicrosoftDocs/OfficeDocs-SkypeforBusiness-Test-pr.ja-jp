...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398428(v=OCS.15)
ms:contentKeyID: 48272289
ms.date: 05/19/2016
...
Verifies that the required permissions needed to install Lync Server or one of its components have been configured on the specified Active Directory container. このコマンドレットは Lync Server 2010 で導入されました。
