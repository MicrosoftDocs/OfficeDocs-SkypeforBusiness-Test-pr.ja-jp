...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412997(v=OCS.15)
ms:contentKeyID: 48273961
ms.date: 05/19/2016
...
Modifies one or more existing client personal identification number (PIN) policies. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. このコマンドレットは Lync Server 2010 で導入されました。
