...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425805(v=OCS.15)
ms:contentKeyID: 48271644
ms.date: 05/19/2016
...
<td><p>Retrieves the external access policy data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
