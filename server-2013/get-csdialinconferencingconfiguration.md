...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398575(v=OCS.15)
ms:contentKeyID: 48272499
ms.date: 05/19/2016
...
Retrieves information about how Lync Server responds when users join or leave a dial-in conference. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the dial-in conferencing data from the local replica of the 中央管理ストア rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
