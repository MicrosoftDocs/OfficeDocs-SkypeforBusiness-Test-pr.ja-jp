...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398125(v=OCS.15)
ms:contentKeyID: 48271141
ms.date: 05/19/2016
...
Returns information about all the users in your organization who have been enabled for Lync Server or a previous version of the software (such as Microsoft Office Communications Server 2007 R2). このコマンドレットは Lync Server 2010 で導入されました。
