...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398116(v=OCS.15)
ms:contentKeyID: 48271133
ms.date: 05/19/2016
...
Retrieves information about the web service provided by the Enhanced 9-1-1 (E9-1-1) Network Routing Provider to validate locations. このコマンドレットは Lync Server 2010 で導入されました。
