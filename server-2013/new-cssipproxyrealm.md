...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413084(v=OCS.15)
ms:contentKeyID: 48274210
ms.date: 05/19/2016
...
Used to assign the default realm (SIP Communications Service) to a collection of proxy configuration settings. Realms (also known as protection domains) are used to authenticate user credentials during logon. このコマンドレットは Lync Server 2010 で導入されました。
