...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205138(v=OCS.15)
ms:contentKeyID: 48273008
ms.date: 05/19/2016
...
Verifies connectivity through the A/V Edge server. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsAVEdgeConnectivity** cmdlet are not available in the Lync Server コントロール パネル.
