...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425847(v=OCS.15)
ms:contentKeyID: 48271760
ms.date: 05/19/2016
...
Modifies an existing collection of health monitoring configuration settings. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. このコマンドレットは Lync Server 2010 で導入されました。
