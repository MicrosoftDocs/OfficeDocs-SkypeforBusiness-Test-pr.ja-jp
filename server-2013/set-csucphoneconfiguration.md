...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413042(v=OCS.15)
ms:contentKeyID: 48274092
ms.date: 05/19/2016
...
Enables you to modify management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. このコマンドレットは Lync Server 2010 で導入されました。
