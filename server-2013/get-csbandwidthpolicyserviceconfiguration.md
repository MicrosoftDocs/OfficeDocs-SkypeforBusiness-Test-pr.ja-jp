...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412727(v=OCS.15)
ms:contentKeyID: 48273029
ms.date: 05/19/2016
...
Retrieves one or more bandwidth policy service configurations. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the bandwidth policy service configuration from the local replica of the 中央管理ストア, rather than from the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
