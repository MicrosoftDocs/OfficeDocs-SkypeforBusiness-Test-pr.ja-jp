...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205140(v=OCS.15)
ms:contentKeyID: 48273132
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** To view Persistent Chat configuration information in the Lync Server コントロール パネル, click **Persistent Chat** and then click **Persistent Chat Configuration**.
