...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425810(v=OCS.15)
ms:contentKeyID: 48271664
ms.date: 05/19/2016
...
Removes the disclaimer text that is used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. このコマンドレットは Lync Server 2010 で導入されました。
