...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205103(v=OCS.15)
ms:contentKeyID: 48272970
ms.date: 05/19/2016
...
Verifies the synchronous replication of a pool by comparing the data stored for a specified user on a primary Front End server with data for that same user stored on replica Front End servers. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the Debug-CsIntraPoolReplication cmdlet are not available in the Lync Server コントロール パネル.
