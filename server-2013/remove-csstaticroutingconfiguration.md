...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398668(v=OCS.15)
ms:contentKeyID: 48272699
ms.date: 05/19/2016
...
Removes the specified collection of static routing configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
