...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205388(v=OCS.15)
ms:contentKeyID: 48274153
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Grant-CsUserServicesPolicy** cmdlet are not available in the Lync Server コントロール パネル.
