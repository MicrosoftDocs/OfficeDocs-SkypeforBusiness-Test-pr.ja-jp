...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425804(v=OCS.15)
ms:contentKeyID: 48271643
ms.date: 05/19/2016
...
Creates a new pool that will contain the computers that host trusted applications. このコマンドレットは Lync Server 2010 で導入されました。
