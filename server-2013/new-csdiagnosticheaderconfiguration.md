...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398350(v=OCS.15)
ms:contentKeyID: 48272092
ms.date: 05/19/2016
...
Creates a new diagnostic header configuration setting collection. Diagnostic header configuration settings determine whether SIP messages are accompanied by header information that can be useful in troubleshooting and error reporting. このコマンドレットは Lync Server 2010 で導入されました。
