...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398573(v=OCS.15)
ms:contentKeyID: 48272496
ms.date: 05/19/2016
...
Removes settings that provide public switched telephone network (PSTN) phone numbers to access Exchange UM Subscriber Access and Auto Attendant features. このコマンドレットは Lync Server 2010 で導入されました。
