...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Hh690041(v=OCS.15)
ms:contentKeyID: 48273252
ms.date: 05/19/2016
...
Verifies that anonymous users can use the Lync Web App to join a Lync Server conference. このコマンドレットは Lync Server 2010 で導入されました。
