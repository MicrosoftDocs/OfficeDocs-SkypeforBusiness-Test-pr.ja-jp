...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425902(v=OCS.15)
ms:contentKeyID: 48271849
ms.date: 05/19/2016
...
Creates a new simple URL entry, an element needed when creating a simple URL. Simple URLs make it easier for users to join meetings and conferences, and also make it easier for Administrators to log on to the Lync Server コントロール パネル. このコマンドレットは Lync Server 2010 で導入されました。
