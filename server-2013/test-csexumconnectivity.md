...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204784(v=OCS.15)
ms:contentKeyID: 48271610
ms.date: 05/19/2016
...
Verifies that a test user can connect to Exchange Unified Messaging. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsExUMConnectivity** cmdlet are not available in the Lync Server コントロール パネル.
