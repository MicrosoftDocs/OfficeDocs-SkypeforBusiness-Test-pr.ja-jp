...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398431(v=OCS.15)
ms:contentKeyID: 48272236
ms.date: 05/19/2016
...
Removes the specified personal identification number (PIN) policy. PIN authentication and PIN policies enable users to access Lync Server by providing a PIN instead of a user name and password. このコマンドレットは Lync Server 2010 で導入されました。
