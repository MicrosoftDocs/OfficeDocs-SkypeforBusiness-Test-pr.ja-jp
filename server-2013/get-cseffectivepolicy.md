...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204636(v=OCS.15)
ms:contentKeyID: 48271091
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Get-CsEffectivePolicy** cmdlet are not directly available in the Lync Server コントロール パネル.
