...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205254(v=OCS.15)
ms:contentKeyID: 48273566
ms.date: 04/05/2017
...
**Lync Server コントロール パネル:** The functions carried out by the **New-CsWatcherNodeConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
