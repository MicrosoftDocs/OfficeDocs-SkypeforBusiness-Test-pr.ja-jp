...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205006(v=OCS.15)
ms:contentKeyID: 48272450
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Set-CsBackupServiceConfiguration** cmdlet are not available in the Lync Server コントロール パネル.
