...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425796(v=OCS.15)
ms:contentKeyID: 48271612
ms.date: 01/13/2017
...
_**トピックの最終更新日:** 2017-01-12_

Modifies an existing collection of proxy server configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the エッジ サーバー. The default value is False.</p></td>
</tr>
<tr class="odd">
