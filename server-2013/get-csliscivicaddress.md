...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398459(v=OCS.15)
ms:contentKeyID: 48272288
ms.date: 05/19/2016
...
Retrieves only the address portion of one or more locations in the location configuration database for Enhanced 9-1-1 (E9-1-1). このコマンドレットは Lync Server 2010 で導入されました。
