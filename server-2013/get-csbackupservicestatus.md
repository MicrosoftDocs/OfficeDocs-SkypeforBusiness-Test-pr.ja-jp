...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205032(v=OCS.15)
ms:contentKeyID: 48272662
ms.date: 05/19/2016
...
Returns information about the current state of the backup service for a specified pool. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Get-CsBackupServiceStatus** cmdlet are not available in the Lync Server コントロール パネル.
