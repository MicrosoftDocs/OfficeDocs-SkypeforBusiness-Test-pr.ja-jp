...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398951(v=OCS.15)
ms:contentKeyID: 48273723
ms.date: 05/19/2016
...
Removes the specified collection of archiving settings. Archiving settings are used to enable or disable the automatic saving of instant messaging (IM) sessions, and to optionally block any instant message that cannot be archived. このコマンドレットは Lync Server 2010 で導入されました。
