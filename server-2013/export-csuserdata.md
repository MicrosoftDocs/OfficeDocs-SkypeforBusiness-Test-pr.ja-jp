...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204897(v=OCS.15)
ms:contentKeyID: 48272088
ms.date: 05/19/2016
...
Exports user data in a format that can be imported into Lync Server. The data will be exported as a .ZIP file containing a pair of XML documents. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Export-CsUserData** cmdlet are not available in the Lync Server コントロール パネル.
