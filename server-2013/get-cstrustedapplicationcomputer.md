...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg425843(v=OCS.15)
ms:contentKeyID: 48271746
ms.date: 05/19/2016
...
Retrieves information about one or more computers that host trusted applications. このコマンドレットは Lync Server 2010 で導入されました。
