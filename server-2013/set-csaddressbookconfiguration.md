...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412784(v=OCS.15)
ms:contentKeyID: 48273172
ms.date: 05/19/2016
...
Modifies an existing collection of Address Book configuration settings. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>When set to True (the default value) the Address Book server generates Address Book index files that can be downloaded by clients. When set to False, these index files are not generated. That means that client applications will have to use the アドレス帳 Web クエリ サービス when searching for contacts.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indicates how often Address Book servers synchronize their information with the information stored in the ユーザー データベース. The SynchronizePollingInterval can be set to any value between 5 seconds (00:00:05) and 3 hours (03:00:00). The default value is 5 minutes (00:05:00).</p></td>
</tr>
<tr class="odd">
