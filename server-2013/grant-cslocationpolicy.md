...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg413049(v=OCS.15)
ms:contentKeyID: 48274174
ms.date: 05/19/2016
...
Assigns an Enhanced 9-1-1 (E9-1-1) location policy to individual users or groups. The E9-1-1 service enables those who answer 911 calls to determine the caller’s geographic location. このコマンドレットは Lync Server 2010 で導入されました。
