...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398461(v=OCS.15)
ms:contentKeyID: 48272296
ms.date: 05/19/2016
...
Removes a Location Information Server (LIS) wireless access point (WAP). このコマンドレットは Lync Server 2010 で導入されました。
