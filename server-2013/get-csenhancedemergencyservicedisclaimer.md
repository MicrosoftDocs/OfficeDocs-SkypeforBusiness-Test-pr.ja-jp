...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412877(v=OCS.15)
ms:contentKeyID: 48273331
ms.date: 05/19/2016
...
Retrieves the disclaimer text that is used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the disclaimer information from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
</tbody>
</table>
