...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg399040(v=OCS.15)
ms:contentKeyID: 48273910
ms.date: 05/19/2016
...
Creates a new Response Group time range. Time ranges are used by the 応答グループ アプリケーション to specify opening and closing times for a business day. For example, if your help desk agents are available only from 12:00 P.M. to 5:00 P.M. on Sundays, then you would create a time range for Sunday that had an opening time of 12:00 P.M. and a closing time of 5:00 P.M. このコマンドレットは Lync Server 2010 で導入されました。
