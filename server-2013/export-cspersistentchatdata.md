...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205378(v=OCS.15)
ms:contentKeyID: 48274127
ms.date: 05/19/2016
...
Exports data from a Persistent Chat database. このコマンドレットは Lync Server 2013 で導入されました。
...
Lync Server コントロール パネル: The functions carried out by the **Export-CsPersistentChatData** cmdlet are not available in the Lync Server コントロール パネル.
