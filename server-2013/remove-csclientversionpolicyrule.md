...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398541(v=OCS.15)
ms:contentKeyID: 48272501
ms.date: 05/19/2016
...
Removes one or more client version policy rules configured for use in your organization. このコマンドレットは Lync Server 2010 で導入されました。
