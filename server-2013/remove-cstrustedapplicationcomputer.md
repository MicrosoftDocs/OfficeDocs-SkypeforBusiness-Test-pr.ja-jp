...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398838(v=OCS.15)
ms:contentKeyID: 48273567
ms.date: 05/19/2016
...
Removes a trusted application computer. このコマンドレットは Lync Server 2010 で導入されました。
