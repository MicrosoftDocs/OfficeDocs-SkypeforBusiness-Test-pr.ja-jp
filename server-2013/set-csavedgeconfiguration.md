...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg412869(v=OCS.15)
ms:contentKeyID: 48273319
ms.date: 05/19/2016
...
Enables you to modify configuration settings for computers running the 音声ビデオ エッジ サービス (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network), as well as exchange files and participate in desktop sharing sessions. このコマンドレットは Lync Server 2010 で導入されました。
