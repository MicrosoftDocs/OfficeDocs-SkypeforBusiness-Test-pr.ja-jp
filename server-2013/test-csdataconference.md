...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205219(v=OCS.15)
ms:contentKeyID: 48273416
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** The functions carried out by the **Test-CsDataConference** cmdlet are not available in the Lync Server コントロール パネル.
