...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398209(v=OCS.15)
ms:contentKeyID: 48271327
ms.date: 05/19/2016
...
Removes an existing range of unassigned numbers and the routing rules that apply to those numbers. このコマンドレットは Lync Server 2010 で導入されました。
