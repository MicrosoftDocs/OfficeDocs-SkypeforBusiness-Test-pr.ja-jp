...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398143(v=OCS.15)
ms:contentKeyID: 48271192
ms.date: 05/19/2016
...
Returns information about the client certificates that have been issued to a user. このコマンドレットは Lync Server 2010 で導入されました。
