...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204656(v=OCS.15)
ms:contentKeyID: 48271182
ms.date: 05/19/2016
...
Verifies whether or not a pair of users can exchange messages using the Persistent Chat service (formerly known as the Group Chat service). このコマンドレットは Lync Server 2013 で導入されました。
...
Lync Server コントロール パネル: The functions carried out by the **Test-CsPersistentChatMessage** cmdlet are not available in the Lync Server コントロール パネル.
