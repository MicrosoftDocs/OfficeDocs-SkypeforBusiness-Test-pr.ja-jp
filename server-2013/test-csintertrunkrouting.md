...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204741(v=OCS.15)
ms:contentKeyID: 48271562
ms.date: 05/19/2016
...
Verifies the route and the PSTN usage used when routing a phone call made from a specified SIP trunk. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the Test-CsInterTrunkRouting cmdlet are not available in the Lync Server コントロール パネル.
