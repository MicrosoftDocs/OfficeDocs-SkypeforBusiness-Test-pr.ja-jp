...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398101(v=OCS.15)
ms:contentKeyID: 48271130
ms.date: 05/19/2016
...
Returns information about one or more voice policies configured for your organization. このコマンドレットは Lync Server 2010 で導入されました。
...
<td><p>Retrieves the voice policy from the local replica of the 中央管理ストア, rather than the 中央管理ストア itself.</p></td>
</tr>
<tr class="even">
