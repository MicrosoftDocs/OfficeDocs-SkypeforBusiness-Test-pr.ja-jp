...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398982(v=OCS.15)
ms:contentKeyID: 48273859
ms.date: 05/19/2016
...
Removes one or more audio conferencing providers assigned to a user or group of users. このコマンドレットは Lync Server 2010 で導入されました。
