...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398528(v=OCS.15)
ms:contentKeyID: 48272487
ms.date: 05/19/2016
...
Moves one or more user accounts enabled for Lync Server to a new Registrar pool. このコマンドレットは Lync Server 2010 で導入されました。
