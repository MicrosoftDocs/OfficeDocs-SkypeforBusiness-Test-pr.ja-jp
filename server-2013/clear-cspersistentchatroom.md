...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204976(v=OCS.15)
ms:contentKeyID: 48272415
ms.date: 05/19/2016
...
Removes all the content from a Persistent Chat chat room beginning with the oldest item in the room and continuing through the specified end date. このコマンドレットは Lync Server 2013 で導入されました。
...
**Lync Server コントロール パネル:** The functions carried out by the **Clear-CsPersistentChatRoom** cmdlet are not available in the Lync Server コントロール パネル.
