...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ204631(v=OCS.15)
ms:contentKeyID: 48271082
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** To create a new XMPP allowed partner using Lync Server コントロール パネル, click External User Access, click XMPP Federated Partners, and then click New.
