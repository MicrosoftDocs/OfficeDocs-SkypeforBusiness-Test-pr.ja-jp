...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398904(v=OCS.15)
ms:contentKeyID: 48273654
ms.date: 05/19/2016
...
Removes an object containing information about the web service provided by the Enhanced 9-1-1 (E9-1-1) Network Routing Provider to verify locations. このコマンドレットは Lync Server 2010 で導入されました。
