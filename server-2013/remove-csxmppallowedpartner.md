...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/JJ205055(v=OCS.15)
ms:contentKeyID: 48272717
ms.date: 05/19/2016
...
**Lync Server コントロール パネル:** To remove an XMPP allowed partner using the Lync Server コントロール パネル, click External User Access and then click XMPP Federated Partners. Select the partner to be removed, click Edit, and then click Delete.
