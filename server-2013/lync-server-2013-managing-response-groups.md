...
<tbody>
<tr class="odd">
<td>応答グループの展開で、1 つのプールに 300 個を超えるワークフローがある場合は、ワークフローの作成に Lync Server 管理シェル コマンドレットを使用することをお勧めします。 応答グループ構成ツールを使用して、300 個を超えるワークフローがあるプールのワークフローを作成すると、Web ページの読み込みに時間がかかります。</td>
</tr>
</tbody>
</table>
