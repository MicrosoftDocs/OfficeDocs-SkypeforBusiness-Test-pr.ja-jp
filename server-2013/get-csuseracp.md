...
ms:mtpsurl: https://technet.microsoft.com/ja-jp/library/Gg398978(v=OCS.15)
ms:contentKeyID: 48273850
ms.date: 05/19/2016
...
Returns information about the audio conferencing providers assigned to a user or group of users. このコマンドレットは Lync Server 2010 で導入されました。
